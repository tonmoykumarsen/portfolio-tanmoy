...
export default function Projects() {
	const projects = [
		...
		{
			name: 'React Blog Management',
			tech: 'React JS | React Router | DaisyUI | Context API | Tailwind CSS',
			img: 'https://i.postimg.cc/C5G7qYf9/screencapture-localhost-5173-2025-11-29-14-31-05.png',
			liveLink: 'https://blog-management-pied.vercel.app/',
			clientLink: 'https://github.com/tonmoykumarsen/blog-management',
			// serverLink: "#",
		},
