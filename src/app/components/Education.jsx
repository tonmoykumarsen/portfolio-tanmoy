              ...
              {index % 2 === 0 ? (
                <div className="relative w-full max-w-lg">
                  <div className="bg-[#1a1f2e] border-b-4 border-indigo-500 p-6 shadow-xl rounded-md">
                    ...
                    <p className="text-gray-300 text-base mb-4">{item.degree}</p>
                    <div className="border-t border-gray-700 pt-4 space-y-2">
                      <p className="text-gray-300 text-sm font-medium">{item.institution}</p>
                      <p className="text-gray-400 text-sm">{item.location}</p>
                      <p className="text-gray-300 text-sm font-medium">{item.result}</p>
                    </div>
                  </div>
            ...
            <div className="bg-[#1a1f2e] border-b-4 border-indigo-500 p-6 shadow-xl rounded-md w-full">
              <div className="flex items-start gap-4 mb-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-gray-300 text-sm md:text-base mt-2">{item.degree}</p>
                </div>
              </div>
